# Generated by Django 5.1.3 on 2025-05-09 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Користувач'), ('author', 'Автор'), ('admin', 'Адміністратор')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('image', 'Зображення'), ('video', 'Відео')], max_length=10)),
